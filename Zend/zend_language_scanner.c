...
ZEND_API int open_file_for_scanning(zend_file_handle *file_handle)
{
	...
	if (CG(start_lineno)) {
		yylloc.last_line = CG(start_lineno);
		CG(start_lineno) = 0;
	} else {
		yylloc.last_line = 1;
	}
...
ZEND_API zend_op_array *compile_file(zend_file_handle *file_handle, int type)
{
	...
	if (open_file_for_scanning(file_handle)==FAILURE) {
		...
		if (!zendparse()) {
			...
			op_array->line_end = yylloc.last_line;
			pass_two(op_array);
...
int start_line = yylloc.last_line;
...
#line 1521 "Zend/zend_language_scanner.c"
	}
/* *********************************** */
...
#line 1939 "Zend/zend_language_scanner.l"
	...
	if (YYCURSOR < YYLIMIT) {
		...
		zend_error(E_COMPILE_WARNING, "Unterminated comment starting line %d", yylloc.last_line);
	}
...
#line 4481 "Zend/zend_language_scanner.c"
yy367:
...
#line 4634 "Zend/zend_language_scanner.c"
yy396:
...
#line 4679 "Zend/zend_language_scanner.c"
yy404:
